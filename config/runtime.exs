...
#
#     PHX_SERVER=true bin/website_45s_v3 start
#
...
if System.get_env("REPLAY_RECORDING") in ["false", "0", "off"] do
  config :website_45s_v3, Website45sV3.Analytics, record_replays: false
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "fortyfives.net"
  ...
  # Bamboo + SES. AWS_* and GOOGLE_* are required and must be non-empty in
  # prod; `fetch_env!` fails fast at boot rather than at first send/login.
